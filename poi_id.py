...
# We can see from this that there are four features that have a score of over
...
parameters = {'SKB__k': range(1,5), 'KNeighborsClassifier__n_neighbors': [1, 5, 10, 15, 20, 25, 30, 35, 40, 45], 
              'KNeighborsClassifier__weights': ('distance', 'uniform')}

CV_SSS = StratifiedShuffleSplit(labels, 100, random_state=42)

knc_clf = grid_search.GridSearchCV(pipe, parameters, scoring = "f1_weighted", cv=CV_SSS)
